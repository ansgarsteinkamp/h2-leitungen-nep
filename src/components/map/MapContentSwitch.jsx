...
// Der Inhalts-Slot "pipelines" trägt je nach Datensatz-Modus ein anderes Label samt Icon und
// Tooltip (NEP: "Maßnahmen" mit Leitungs-Icon, Marktabfrage: "Projekte" mit Formen-Icon).
const buildMapContentOptions = (contentLabel, contentIcon, contentTooltip) => [
   { icon: contentIcon, label: contentLabel, tooltip: contentTooltip, value: "pipelines" },
   {
      icon: MapPin,
      label: "Orte",
      tooltip: "Ortschaften anzeigen",
      value: "places"
   }
];
...
export default function MapContentSwitch({
   contentIcon = Route,
   contentLabel = "Maßnahmen",
   contentTooltip = "Maßnahmen auf der Karte anzeigen",
   ...
   return (
      ...
      >
         <div className="grid w-[6.75rem] gap-0.5 xs:w-[7.25rem]">
            {buildMapContentOptions(contentLabel, contentIcon, contentTooltip).map(option => {
